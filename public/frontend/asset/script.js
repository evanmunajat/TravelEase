...
window.addEventListener('load', function() {
    var berandaLink = document.querySelector('.navbar-nav .nav-item:first-child .nav-link');
...
function toggleText() {
    ...
    var learnMoreText = description.classList.contains('expanded') ? 'Tampilkan Lebih Sedikit' : 'Pelajari Lebih Lanjut';
...
function filterCategory(category) {
    ...
    const activeButton = document.querySelector(`.menu-btn[onclick="filterCategory('${category}')"]`);
    if (activeButton) {
