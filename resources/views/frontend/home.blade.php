    ...
    <div id="popup" class="popup">
        ...
        <div class="container py-5">
            <div class="content-header">
                <div class="text-header">
                    ...
                    <div class="class-button">
                        <div class="button-header-1">
                            <button>
                                <a href="javascript:void(0);" onclick="showLoginModal()">Memulai</a>
                        </button>
                    </div>
                ...
                <div class="hero-section-header">
                    <img src="{{ asset('frontend/asset/image/hero-section-header.svg') }}" alt="">
                </div>
            </div>

            <div class="logo-header">
                <img src="{{ asset('frontend/asset/icon/logo/Group 2.svg') }}" alt="">
                <img src="{{ asset('frontend/asset/icon/logo/Group 3.svg') }}" alt="">
                <img src="{{ asset('frontend/asset/icon/logo/Group 9235.svg') }}" alt="">
                <img src="{{ asset('frontend/asset/icon/logo/Group-1.svg') }}" alt="">
                <img src="{{ asset('frontend/asset/icon/logo/Group.svg') }}" alt="">
            </div>
        </div>
     </header>
     {{-- Close Header --}}
        ...
        <div class="content-serve">
            ...
            <div class="card-serve">
                <div class="card-body-serve">
                    <img src="{{ asset('frontend/asset/icon/Features/Travel anywhere in the world with a suitcase.svg') }}" alt="">
            ...
            <div class="card-serve">
                <div class="card-body-serve">
                    <img src="{{ asset('frontend/asset/icon/Features/yellow paper airplane.svg') }}" alt="">
            ...
            <div class="card-serve">
                <div class="card-body-serve">
                    <img src="{{ asset('frontend/asset/icon/Features/card.svg') }}" alt="">
        ...
        <div class="content-card-destinasi mt-3">
            ...
            <div class="card-container" id="group1">
                <div class="card-destinasi">
                    ...
                    <img src="{{ asset('frontend/asset/image/destinasi/Rectangle 1434-1.svg') }}" alt="Destinasi Travel">
     ...
     <div class="container py-3">
        <div class="content-service-section">
            <div class="hero-img">
                <img src="{{ asset('frontend/asset/image/hero-02.svg') }}" alt="">
            </div>
     ...
     <div class="container py-3">
            <div class="content-service-section">
                ...
                <div class="hero-img-experience">
                    <img src="{{ asset('frontend/asset/image/pixeltrue-location-1.svg') }}" alt="">
                </div>
            </div>
         </div>
         ...
         <div class="content-text-pemandu">
            ...
            <div class="card-pemandu-travel" style="margin-top: -10%">
                <div class="card-body-pemandu-travel">
                    <img src="{{ asset('frontend/asset/icon/icon-hand.svg') }}" alt="">
                ...
                <div class="card-pemandu-travel">
                    <div class="card-body-pemandu-travel">
                        <img src="{{ asset('frontend/asset/icon/icon-love.svg') }}" alt="">
                        <div class="text-card-pemandu-travel">
                            <h1>Gairah</h1>
                ...
                <div class="card-pemandu-travel">
                    <div class="card-body-pemandu-travel">
                        <img src="{{ asset('frontend/asset/icon/icon-arrow.svg') }}" alt="">
                        <div class="text-card-pemandu-travel">
                            <h1>Dedikasi</h1>
    ...
    <div class="container py-5">
        <div class="bg-contact justify-center text-center">
            {{-- <div class="img-icon-pesawat">
                <img class="img-pesawat" src="{{ asset('frontend/asset/image/pesawat.svg') }}" alt="">
            </div>
            <h1 class="">Daftar dan nikmati manfaat eksklusif!</h1>
            <div class="img-icon-location">
                <img class="img-location" src="{{ asset('frontend/asset/image/location.svg') }}" alt="">
            </div> --}}
